    ...
    <div class="bg-white">
        ...
        <main>
            ...
            <div class="relative isolate pt-14">
                ...
                <div
                    class="px-6 py-24 mx-auto max-w-7xl sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40"
                >
                    <div class="max-w-2xl mx-auto lg:mx-0 lg:flex-auto">
                        <div class="flex">
                            <div
                                class="relative flex items-center px-4 py-1 text-sm leading-6 text-gray-600 rounded-full gap-x-4 ring-1 ring-gray-900/10 hover:ring-gray-900/20"
                            >
                        ...
                        <h1
                            class="max-w-lg mt-10 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl"
                        >
            ...
            <div class="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
                <div
                    class="relative px-6 py-20 overflow-hidden bg-gray-900 isolate sm:rounded-3xl sm:px-10 sm:py-24 lg:py-24 xl:px-24"
                >
                    <div
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <dt
                                        class="inline-block font-semibold text-white ml-9"
                                    >
                                        <component
                                            :is="feature.icon"
                                            class="absolute w-5 h-5 text-indigo-500 left-1 top-1"
                                            aria-hidden="true"
                                        />
                                        {{ feature.name }}
                                    </dt>
            ...
            <div class="px-6 mx-auto mt-32 max-w-7xl sm:mt-56 lg:px-8">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <dt
                                class="flex items-center text-base font-semibold leading-7 text-gray-900 gap-x-3"
                            >
                                <component
                                    :is="feature.icon"
                            ...
                            <dd
                                class="flex flex-col flex-auto mt-4 text-base leading-7 text-gray-600"
                            >
                                <p class="flex-auto">
                                    {{ feature.description }}
                                </p>
            ...
            <div class="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
                <div
                    class="relative px-6 py-24 overflow-hidden bg-gray-900 shadow-2xl isolate sm:rounded-3xl sm:px-24 xl:py-32"
                >
                    <h2
                        class="max-w-2xl mx-auto text-3xl font-bold tracking-tight text-center text-white sm:text-4xl"
                    >
                        Get notified when we’re launching.
                    </h2>
                    <p
                        class="max-w-xl mx-auto mt-2 text-lg leading-8 text-center text-gray-300"
                    >
            ...
            <div class="relative mt-32 isolate sm:mt-56 sm:pt-32">
                ...
                <div class="relative">
                    ...
                    <div
                        class="absolute inset-x-0 top-0 flex pt-8 overflow-hidden opacity-25 -z-10 transform-gpu blur-3xl xl:justify-end"
                        aria-hidden="true"
                    >
                        <div
                    ...
                    <div class="px-6 mx-auto max-w-7xl lg:px-8">
                        ...
                        >
                            ...
                            >
                                ...
                                <figcaption
                                    class="flex items-center px-6 py-4 border-t gap-x-4 border-gray-900/10"
                                >
                                    <img
                            ...
                            >
                                ...
                                >
                                    <figure
                                        ...
                                        class="p-6 bg-white shadow-lg rounded-2xl ring-1 ring-gray-900/5"
                                    >
        ...
        >
            ...
            <div
                class="px-6 pt-16 pb-8 mx-auto max-w-7xl sm:pt-24 lg:px-8 lg:pt-32"
            >
                ...
                >
                    ...
                    <form class="mt-6 sm:flex sm:max-w-md lg:mt-0">
                        ...
                        <div class="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                            <button
                                type="submit"
                                class="flex items-center justify-center w-full px-3 py-2 text-sm font-semibold text-white bg-indigo-500 rounded-md shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
                            >
                                Subscribe
                            </button>
                        </div>
                ...
                <div
                    class="pt-8 mt-8 border-t border-white/10 md:flex md:items-center md:justify-between"
                >
