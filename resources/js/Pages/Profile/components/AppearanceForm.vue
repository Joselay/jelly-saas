                ...
                >
                    <FormItem>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="p-2 space-y-2 bg-white rounded-md shadow-sm"
                                    >
                                        <div
                                            class="h-2 w-20 rounded-lg bg-[#ecedef]"
                                        />
                                        <div
                            ...
                            <span
                                class="block w-full p-2 font-normal text-center"
                            >
                                Light
                            </span>
                        </FormLabel>
                    ...
                    <FormItem>
                        ...
                        >
                            ...
                            >
                                <div
                                    class="p-2 space-y-2 rounded-sm bg-slate-950"
                                >
                                    <div
                                        class="p-2 space-y-2 rounded-md shadow-sm bg-slate-800"
                                    >
                                        <div
                                            class="w-20 h-2 rounded-lg bg-slate-400"
                                        />
                                        <div
